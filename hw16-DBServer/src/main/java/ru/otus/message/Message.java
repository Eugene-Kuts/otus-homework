...
// то он должен удовлетворять следующим требованиям в реалзиации каждой из компонент:
...
//      Желательно, чтобы значение serialVersionUID было отличным от 1L, т.к. это самое распространненное значение.
